...
namespace Persistence.Migrations
{
    ...
    [Migration("20260512181210_AddDragonOrders")]
    partial class AddDragonOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DragonOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTime?>("FactoryPaidAt")
                        .HasColumnType("TEXT");

                    b.Property<bool>("IsClubeDragon")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsFactoryPaid")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsFullyPaid")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsOwnOrder")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("DragonOrders");
                });

            modelBuilder.Entity("Domain.Entities.DragonOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("DragonOrderId");

                    b.ToTable("DragonOrderItems");
                });

            modelBuilder.Entity("Domain.Entities.DragonPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("DragonPayments");
                });

            modelBuilder.Entity("Domain.Entities.FactoryOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Domain.Entities.FactoryOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("SubtotalSalePrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Domain.Entities.DragonOrderItem", b =>
                {
                    b.HasOne("Domain.Entities.DragonOrder", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.FactoryOrderItem", b =>
                {
                    b.HasOne("Domain.Entities.FactoryOrder", null)
                        .WithMany("Items")
